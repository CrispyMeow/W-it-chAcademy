...
def hallway():
    ...
    global PLAYER_POSITION_X
    global PLAYER_POSITION_Y
    wall = [(0, 238, 0, 118), (283, 1280, 0, 118), (0, 418, 133, 282), (28, 103, 0, 118), (118, 208, 0, 118), (312, 418, 0, 118), (403, 508, 0, 118)]
...
#------------------------------------
    ...
    if gohallway == True: #HALLWAY
        wall_hallway = [(0, 238, 0, 133), (283, 1280, 0, 118), (0, 418, 133, 282), (28, 103, 0, 133), (118, 208, 0, 133), \
                        (283, 418, 0, 133), (403, 508, 0, 133), (538, 1183, 0, 133), (538, 793, 133, 223), (493, 568, 0, 223)]
        # hallway()
        rel_x = -X % bg_width
        rel_y = -Y % bg_height
        wall(wall_hallway)
